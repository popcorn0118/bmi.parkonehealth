...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    update_option("parkone_swipe_qrcode_txt", json_encode($post_parkone_ad_qrcode_txt));
}
?>

<h1>案例代碼設定</h1>
<button type=button id=btn_add_swipe>新增案例代碼</button>
...
if(is_array($parkone_swipe_qrcode_txt)){
    foreach($parkone_swipe_qrcode_txt as $key => $value):
        ?>
...
<script>
    jQuery("#btn_add_swipe").on("click", function(){
