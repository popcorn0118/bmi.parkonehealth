...
$title_en = get_field( 'title_en' ) ? get_field( 'title_en' ) : 'Inbody History';
$title = get_field( 'title' ) ? get_field( 'title' ) : 'inbody歷程記錄';
...
<div <?php echo $anchor; ?>class="<?php echo esc_attr( $class_name ); ?> mt-16">
    ...
    <div class="eos-img-wrap">
        <?php foreach($images as $image): ?>
            <?php if($is_preview): ?>
                <?php echo wp_get_attachment_image( $image['id'], [1120, 560] ); ?>
            <?php else: ?>
            <a class="glightbox"
